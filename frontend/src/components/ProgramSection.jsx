		...
		<div className="py-20">
			<div className="max-w-7xl mx-auto px-6">
				<div className="text-center mb-12">
					<h2 className="text-4xl font-bold text-black mb-2">Our Programs</h2>
					<p className="text-lg text-black">Elite training programs designed to elevate your game and unlock your potential</p>
				</div>
